...
class CarradaDataset(Dataset):
    ...
    def __init__(self, dataset, dataset_type, annotation_type, path_to_frames, process_signal,
        ...
        self.path_to_annots = self.path_to_frames / dataset_type / self.annotation_type
    ...
    def __getitem__(self, idx):
        ...
        # lt @20230406
        # flip ra to align the range dimension in ra and rd
        ra_matrix = ra_matrix[..., ::-1, ::-1].copy()
        ra_mask = ra_mask[..., ::-1, ::-1].copy()
